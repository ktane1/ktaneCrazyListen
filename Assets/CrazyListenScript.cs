...
public class CrazyListenScript : MonoBehaviour
{
    ...
    private static string[] speakerNames = new string[] { "weird", "Kilo", "Arceus", "Deader", "CrazyCaleb", "Kabewm", "Depresso", "MásQuéÉlite", "FlompStompton", "Shadow Meow", "Pippy", "Dbros", "Luna", "ScopingLandscape", "Gwen", "Day", "yabba", "Jay", "Boxpone", "ManiaMate", "Obvious", "Eltrick", "GhostSalt", "Whalien", "Rdzanu", "DeeDeeEn", "Logan" };
    private static int[] speakerValues = new int[] { 43, 41, 48, 61, 76, 85, 88, 40, 34, 42, 29, 28, 78, 95, 55, 80, 22, 53, 38, 77, 28, 30, 21, 52, 16, 50, 74 };
